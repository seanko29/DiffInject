...
config="afhq.yml"     # Other option: afhq.yml celeba.yml metfaces.yml ffhq.yml lsun_bedroom.yml ...
content_dir="./test_images/dogs_n_cats/contents"
style_dir="./test_images/dogs_n_cats/styles"
